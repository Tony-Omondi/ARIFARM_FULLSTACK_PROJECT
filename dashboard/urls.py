...
urlpatterns = [
    ...
    path('recipes/<slug:slug>/delete/', views.RecipeDelete.as_view(), name='recipe_delete'),
    ...
    path('zones/<int:pk>/delete/', views.ZoneDelete.as_view(), name='zone_delete'),
    ...
    path('gallery/categories/<int:pk>/delete/', views.GalCatDelete.as_view(), name='gallery_cat_delete'),
    ...
    path('gallery/items/<int:pk>/delete/', views.GalItemDelete.as_view(), name='gallery_item_delete'),
